...
plt.subplot(2, 1, 1)
# plt.title("Gyro")
plt.plot(dataframe["timestamp(ms)"], dataframe["IMU[0].GyrX"],       label='Gyro X (Roll)',         marker=',', color='#ff0000', alpha=1.0)
plt.plot(dataframe["timestamp(ms)"], dataframe["IMU[0].GyrY"],       label='Gyro Y (Pitch)',        marker=',', color='#00ff00', alpha=1.0)
plt.plot(dataframe["timestamp(ms)"], dataframe["IMU[0].GyrZ"],       label='Gyro Z (Yaw)',          marker=',', color='#0000ff', alpha=1.0)
plt.ylabel('Ang. Rate (deg/sec)')
plt.xlim(2100000, 2120000)
